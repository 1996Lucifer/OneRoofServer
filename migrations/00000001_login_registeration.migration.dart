...
class Migration1 extends Migration {
  ...
  Future upgrade() async {
    database.createTable(SchemaTable("_LoginRegistration", [
      SchemaColumn("fullName", ManagedPropertyType.string,
          isPrimaryKey: false,
          autoincrement: false,
          isIndexed: false,
          isNullable: false,
          isUnique: false),
      SchemaColumn("emailId", ManagedPropertyType.string,
          isPrimaryKey: false,
          autoincrement: false,
          isIndexed: false,
          isNullable: true,
      ...
      SchemaColumn("password", ManagedPropertyType.string,
          ...
          isNullable: false,
          isUnique: false),
      SchemaColumn("profilePicture", ManagedPropertyType.string,
          isPrimaryKey: false,
          autoincrement: false,
          isIndexed: false,
          isNullable: true,
          isUnique: false),
      SchemaColumn("timeStamp", ManagedPropertyType.datetime,
          isPrimaryKey: false,
          autoincrement: false,
          isIndexed: false,
          isNullable: false,
  ...
  Future seed() async {
    await database.store.execute(
        "INSERT INTO _LoginRegistration (fullName,emailId,mobileNumber,password,profilePicture,timeStamp) VALUES (@fullName,@emailId,@mobileNumber,@password,@profilePicture,@timeStamp)",
        substitutionValues: {
          "fullName": "Deepak Kumar Jha",
          "emailId": "dj12885@gmail.com",
